<?php
  ...
  if($_POST){
    ...
    $sql = "INSERT INTO proyects (`name_company`, `name_proyect`,`updated_at`,`status`,`observation`,`price_proyect`)
    VALUES ('$name_company', '$name_proyect',NOW(),'$status','$observation',$price);";
